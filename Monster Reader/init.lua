...
if optionsLoaded then
    ...
    options.mhpX                 = lib_helpers.NotNilOrDefault(options.mhpX, 100)
    options.mhpY                 = lib_helpers.NotNilOrDefault(options.mhpY, -800)
    options.mhpW                 = lib_helpers.NotNilOrDefault(options.mhpW, 990)
    ...
    options.foRecX                   = lib_helpers.NotNilOrDefault(options.foRecX, 0)
    options.foRecY                   = lib_helpers.NotNilOrDefault(options.foRecY, -300)
    options.foRecW                   = lib_helpers.NotNilOrDefault(options.foRecW, 200)
    ...
    options.target2X                   = lib_helpers.NotNilOrDefault(options.target2X, 0)
    options.target2Y                   = lib_helpers.NotNilOrDefault(options.target2Y, -300)
    options.target2W                   = lib_helpers.NotNilOrDefault(options.target2W, 400)
    options.target2H                   = lib_helpers.NotNilOrDefault(options.target2H, 205)
